    ...
    <div class="min-h-screen bg-gray-50/50">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Analisis sentimen data dari berbagai platform sosial media</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
                ...
                <template v-else>
                    <div
                        class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-6 hover:shadow-lg transition-all duration-300 group">
                        ...
                        <h3 class="text-gray-600 text-sm font-medium mb-1">Total Positive</h3>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-gray-600 text-sm font-medium">+5.2%</span>
                        </div>
                        <h3 class="text-gray-600 text-sm font-medium mb-1">Total Neutral</h3>
                        <p class="text-2xl font-bold text-gray-900 mb-1">{{
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="w-12 h-12 bg-red-100 rounded-xl flex items-center justify-center group-hover:bg-red-200 transition-colors">
                                <TrendingDown class="w-6 h-6 text-red-600" />
                            </div>
                            <span class="text-red-600 text-sm font-medium">-8.1%</span>
                        </div>
                        <h3 class="text-gray-600 text-sm font-medium mb-1">Total Negative</h3>
                        <p class="text-2xl font-bold text-gray-900 mb-1">{{
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-blue-600 text-sm font-medium">+15.3%</span>
                        </div>
                        <h3 class="text-gray-600 text-sm font-medium mb-1">Total Data</h3>
                        <p class="text-2xl font-bold text-gray-900 mb-1">{{
                            sentimentStore.totalStats.total.toLocaleString() }}</p>
                        <p class="text-blue-600 text-sm font-medium">6 Platform</p>
                    </div>
                </template>
            </div>
